...
namespace Kata.Spec
{
    ...
    public class when_input_is_unknown_amount_of_numbers
    {
        ...
        It should_return_the_sum_of_all = () => { _result.Should().Be(10); };
        static Calculator _systemUnderTest;
        static int _result;
    }
    ...
    public class when_input_is_unknown_amount_of_numbers_and_new_line_and_comma_delimiters
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };
    ...
    public class when_input_is_multiple_numbers_with_custom_single_character_delimiter
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };
